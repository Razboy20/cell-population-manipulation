...
var grammar = {
    ...
    {"name": "line", "symbols": ["_", "statement", "_", "line$ebnf$1", "_"], "postprocess": function(d) {return d[1]}},
    ...
    {"name": "function", "symbols": ["f_leader_elect"], "postprocess": id},
    {"name": "function", "symbols": ["f_select"], "postprocess": id},
    {"name": "f_leader_elect$subexpression$1", "symbols": [/[lL]/, /[eE]/, /[aA]/, /[dD]/, /[eE]/, /[rR]/, {"literal":"_"}, /[eE]/, /[lL]/, /[eE]/, /[cC]/, /[tT]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "f_leader_elect", "symbols": ["f_leader_elect$subexpression$1", {"literal":"("}, "_", "setp", "_", {"literal":")"}], "postprocess": function(d) {return {type: "f-leaderelect", group: d[3]}}},
    {"name": "f_select$subexpression$1", "symbols": [/[sS]/, /[eE]/, /[lL]/, /[eE]/, /[cC]/, /[tT]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "f_select", "symbols": ["f_select$subexpression$1", {"literal":"("}, "_", "var", "_", {"literal":","}, "_", "conds", "_", {"literal":")"}], "postprocess": function(d) {return {type: "f-select", group: d[3], conds: d[7]}}},
